  ...
  return (
    ...
    >
      <div
        ...
        onClick={() => setOpen((o) => !o)}
        onMouseEnter={(e) => {
          if (!open) e.currentTarget.style.background = "rgba(255,255,255,0.032)";
        }}
        onMouseLeave={(e) => {
          if (!open) e.currentTarget.style.background = "rgba(255,255,255,0.018)";
        }}
        style={{
          background: open ? "rgba(255,255,255,0.042)" : "rgba(255,255,255,0.018)",
          border: "1px solid rgba(255,255,255,0.07)",
          borderLeft: hl ? `2px solid ${open ? "#81c784" : "rgba(129,199,132,0.38)"}` : "1px solid rgba(255,255,255,0.07)",
          borderRadius: 10,
          padding: "16px 18px",
          cursor: "pointer",
          ...
          <div style={{ marginTop: 14, paddingTop: 14, borderTop: "1px solid rgba(255,255,255,0.055)", textAlign: "left" }}>
            ...
            <div
              style={{
                ...
                gap: 7,
                padding: "9px 11px",
                background: "rgba(129,199,132,0.055)",
              ...
              <span style={{ fontSize: 12, color: "rgba(255,255,255,0.58)", lineHeight: 1.5, flex: 1, minWidth: 0, textAlign: "left", display: "block" }}>
                ...
                {exp.paperLink && (
                  <a
                    ...
                    style={{ marginLeft: 8, color: "#81c784", textDecoration: "none", fontSize: 11 }}
                  >
                    View paper ↗
                  </a>
                )}
    ...
    >
      {item.link ? (
        <a href={item.link} target="_blank" rel="noopener noreferrer" style={{ textDecoration: "none", color: "inherit" }}>
          ...
          <div style={{ marginTop: 6, fontSize: 10, color: "#81c784", letterSpacing: "0.05em", display: "flex", alignItems: "center", justifyContent: "center", gap: 3 }}>
            {item.label}
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 7 }}>
          ...
          <span style={{ fontSize: 9, padding: "1px 5px", background: p.badgeBg, color: p.badgeColor, borderRadius: 3, border: `1px solid ${p.badgeBorder}`, fontWeight: 700, letterSpacing: "0.07em" }}>
            {status.toUpperCase()}
          </span>
        </div>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="experience-column" style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
